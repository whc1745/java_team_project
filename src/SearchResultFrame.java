...
public class SearchResultFrame extends javax.swing.JFrame {
    ...
    public SearchResultFrame() {
        initComponents();
        jPanel80.setLayout(new javax.swing.BoxLayout(jPanel80, javax.swing.BoxLayout.Y_AXIS)); // 수직 레이아웃 설정
    }
    ...
    private void updatePage() {
        ...
        for (int i = start; i < end; i++) {
            ...
            String userName = recipe.getString("name");
            int visited = recipe.getInt("visited");
            ...
            JLabel descLabel = new JLabel("설명: " + description);
            JLabel userLabel = new JLabel("작성자: " + userName);
            JLabel visitedLabel = new JLabel("조회수: " + visited);

            recipePanel.add(titleLabel);
            recipePanel.add(descLabel);
            recipePanel.add(userLabel);
            recipePanel.add(visitedLabel);

            // 상세 페이지로 이동
            recipePanel.addMouseListener(new MouseAdapter() {
                @Override
                public void mouseClicked(MouseEvent evt) {
//                    new RecipeDetailFrame(recipe).setVisible(true);
                }
            });

            jPanel80.add(recipePanel);
        }

        jPanel80.revalidate();
        jPanel80.repaint();
        jLabel1.setText(String.valueOf(currentPage)); // 현재 페이지 표시
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(jPanel79, javax.swing.GroupLayout.PREFERRED_SIZE, 288, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
